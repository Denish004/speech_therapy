      ...
      <div className="mt-8 pb-10 bg-orange-50 rounded-t-[60px] border-t-8 border-t-indigo-900">
        <div className="flex justify-evenly">
          <div className="p-5 w-1/2">
            <h1 className="flex justify-center text-3xl mb-5  ">Your Progress</h1>
            <LineChartCardDS />
          </div>
          {user && user.role == "patient" ?( <div className="p-5 w-1/2">
            <h1 className="flex justify-center text-3xl mb-5  ">User Exercise</h1>
            <UserExercise /> 
          </div>):(
            <UserExercise /> 
          )}
        ...
        <div className="flex justify-evenly mt-8">
          <div className="p-5 w-1/2">
            <h1 className="flex justify-center text-3xl mb-5  ">Your Schedule</h1>
            <CalendarStyledDS />
          </div>
          <div className="p-5 w-1/2">
            <h1 className="flex justify-center text-3xl mb-5  ">Sessions</h1>
            <SessionsDS />
          </div>
        </div>
      </div>
