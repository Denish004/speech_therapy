...
const StyledWrapper = styled.div`
  ...
  .loader span {
    ...
    letter-spacing: -2rem; /* Adjust spacing based on new font size */
    animation-delay: 0s;
    transform: translateY(6rem); /* Adjust based on new font size */
  ...
  .letter {
    width: fit-content;
    height: 10rem; /* Adjust based on new font size */
  }

  .i {
    margin-inline: 10px; /* Adjust based on new font size */
  }
