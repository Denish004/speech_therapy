    ...
    <StyledWrapper>
      <div className="card">
        ...
        <div className="bottom">
          ...
          <div className="bottom-bottom" style={{marginLeft:'65px'}}>
            ...
            <button  style={{width:'130px',height:35}}className="button">Show More</button>
          </div>
        </div>
      </div>
    </StyledWrapper>
